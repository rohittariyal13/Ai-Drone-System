...
export const ALERTS = [
  {
    ...
    type: "THREAT",
    severity: "red",
    message: "POI MATCH · SALIM-002 detected UAV-01 · Conf 91% · 34°01'22\"N · Gait+body match despite covered face",
    time: "14:32",
  },
  {
    id: 2,
    type: "SUSPECT",
    severity: "orange",
    message: "Face-covered individual UAV-03 · Gait analysis running · Movement pattern anomaly detected",
    time: "14:31",
  },
  {
    id: 3,
    type: "CRITICAL",
    severity: "red",
    message: "UAV-02 battery 28% · ~6 min flight time · Recall recommended immediately",
    time: "14:30",
  },
  {
    id: 4,
    type: "ZONE",
    severity: "orange",
    message: "Unidentified vehicle (truck) approaching restricted zone · UAV-01 tracking",
    time: "14:28",
  },
];
